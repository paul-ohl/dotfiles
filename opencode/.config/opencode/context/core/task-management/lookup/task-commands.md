...
```bash
npx ts-node /home/astro/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/home/astro/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
