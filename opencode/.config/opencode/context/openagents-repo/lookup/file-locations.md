...
| **Context files** | `/home/astro/.config/opencode/context/` |
...
| **New context** | `/home/astro/.config/opencode/context/{category}/{name}.md` |
...
```
/home/astro/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/home/astro/.config/opencode/context/core/standards/code-quality.md`
- `/home/astro/.config/opencode/context/ui/web/react-patterns.md`
- `/home/astro/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /home/astro/.config/opencode/context/{category}/

# All context
find /home/astro/.config/opencode/context -name "*.md"
```
