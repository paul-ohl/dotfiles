...
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-7 "['<Shift><Control><Alt><Super>7']"
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-8 "['<Shift><Control><Alt><Super>8']"
gsettings set org.gnome.desktop.wm.keybindings move-to-workspace-9 "['<Shift><Control><Alt><Super>9']"
...
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-7 "['<Shift><Alt><Super>7']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-8 "['<Shift><Alt><Super>8']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-9 "['<Shift><Alt><Super>9']"
...
gsettings set org.gnome.shell favorite-apps "['kitty.desktop', 'org.mozilla.firefox.desktop', 'org.gnome.Nautilus.desktop', 'com.spotify.Client.desktop']"
