...
local function lsp_keymaps(buffer)
	...
	vim.api.nvim_buf_set_keymap(buffer, "n", "<leader>r", "<Cmd>lua vim.lsp.buf.rename()<CR>", opts)
	...
	vim.api.nvim_buf_set_keymap(buffer, "n", "<leader>i", "<Cmd>lua vim.diagnostic.open_float()<CR>", opts)
	vim.api.nvim_buf_set_keymap(buffer, "n", "gl", "<Cmd>lua vim.diagnostic.open_float()<CR>", opts)
